...
public abstract class AbstractTheCursedCard extends CustomCard {
	...
	public AbstractTheCursedCard(String id, String name, String img, int cost, String rawDescription, CardType type, CardRarity rarity, CardTarget target, int cardPool){
		super(id, name, TheCursedMod.getResourcePath(img), cost, rawDescription, type, AbstractCardEnum.CURSED, rarity, target);
	}
